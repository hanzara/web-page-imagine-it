...
const AdvancedChamaPage: React.FC = () => {
  ...
  const chamaData = {
    ...
    rules: 'All members must contribute on time. Loans require 2/3 majority approval. No member can borrow more than 3x their total contributions.',
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="admin">
            <AdminTools chamaData={chamaData} userRole={chamaData.role} />
          </TabsContent>
