  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Add smart authentication animation
            ...
            <Card className="w-full max-w-md mx-auto bg-card/80 backdrop-blur-xl border border-border/50 shadow-2xl shadow-primary/5 hover:shadow-primary/10 transition-all duration-500 animate-fade-in">
              <CardHeader className="text-center pb-8">
                <div className="flex justify-center mb-4">
                  <div className="auth-logo w-16 h-16 bg-gradient-primary rounded-2xl flex items-center justify-center shadow-lg transition-all duration-500">
          ...
          <div className="lg:col-span-3 space-y-8 text-center lg:text-left order-1 lg:order-2 animate-fade-in">
            ...
            <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-8 border border-primary/20">
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Processing $12.5B+ in payments monthly with 99.99% uptime
                </p>
              </div>
              
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 items-center opacity-60 hover:opacity-80 transition-opacity duration-300">
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                ...
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Shopify</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Square</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Klarna</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Wise</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Revolut</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Adyen</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Plaid</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Flutterwave</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">Paystack</span>
                </div>
                <div className="flex items-center justify-center p-3 bg-card/30 rounded-lg">
                  <span className="font-bold text-sm text-foreground">M-Pesa</span>
                </div>
              </div>
            </div>
          </div>
