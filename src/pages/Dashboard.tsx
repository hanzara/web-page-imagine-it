...
import { FinTechNavigation } from "@/components/FinTechNavigation";
...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-dashboard">
      <FinTechNavigation 
        ...
        <SidebarProvider>
          <div className="flex-1 flex w-full">
            ...
            <div className="flex-1 flex flex-col">
              ...
              <header className="h-14 sm:h-16 flex items-center border-b border-border bg-card/90 shadow-card backdrop-blur px-3 sm:px-4 lg:hidden">
