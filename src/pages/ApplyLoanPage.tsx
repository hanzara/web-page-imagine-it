                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-4 p-6 bg-gradient-to-r from-purple-50/50 to-pink-50/50 dark:from-slate-800/50 dark:to-slate-700/50 rounded-xl border border-purple-200/20">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-3">
                        <Label htmlFor="collateral" className="text-base font-medium flex items-center gap-2">
                          <Shield className="h-4 w-4" />
                          Collateral (Optional)
                        </Label>
                        <Textarea
                          id="collateral"
                          placeholder="Describe any collateral you can provide (property, assets, guarantors)..."
                          value={collateral}
