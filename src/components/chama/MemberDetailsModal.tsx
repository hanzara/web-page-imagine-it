...
import { User, Phone, Mail, Wallet, TrendingUp, AlertCircle, Download, Edit2 } from 'lucide-react';
...
export const MemberDetailsModal: React.FC<MemberDetailsModalProps> = ({
  ...
  const handleNameSave = () => {
    if (editedName.trim() && onUpdateName) {
      onUpdateName(member.user_id, editedName.trim());
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                {isEditingName ? (
                  ...
                  <div className="flex items-center gap-2">
                    <h3 className="text-lg font-semibold">{profile?.display_name || 'Unknown Member'}</h3>
