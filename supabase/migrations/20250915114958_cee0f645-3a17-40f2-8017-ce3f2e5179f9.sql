...
DROP POLICY IF EXISTS "Users can create lending offers" ON public.peer_lending_offers;
DROP POLICY IF EXISTS "Users can view offers they sent or received" ON public.peer_lending_offers;
DROP POLICY IF EXISTS "Borrowers can update offer status" ON public.peer_lending_offers;
DROP POLICY IF EXISTS "Lenders can update their offers" ON public.peer_lending_offers;
DROP POLICY IF EXISTS "Users can view their lending transactions" ON public.peer_lending_transactions;
DROP POLICY IF EXISTS "Users can create lending transactions" ON public.peer_lending_transactions;
DROP POLICY IF EXISTS "Users can manage their own profile photo" ON public.user_profile_photos;
