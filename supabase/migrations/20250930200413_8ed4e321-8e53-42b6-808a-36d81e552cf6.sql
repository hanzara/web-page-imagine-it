-- Create function to initialize chama on creation
...
BEGIN
  ...
  -- Create MGR wallet for creator
  INSERT INTO public.user_wallets_v2 (user_id, chama_id, wallet_type, withdrawal_locked)
  VALUES (NEW.created_by, NEW.id, 'mgr', false)
  ON CONFLICT ON CONSTRAINT unique_user_chama_wallet DO NOTHING;
  
  -- Create chama-view-only wallet for creator
  INSERT INTO public.user_wallets_v2 (user_id, chama_id, wallet_type, withdrawal_locked)
...
-- Create trigger for chama initialization
